...
def analyze_small_csv():
    ...
    print(f"Date range: {insights['date_range']['earliest']} to {insights['date_range']['latest']}")
...
def demonstrate_chunking():
    ...
    for chunk_num, chunk in enumerate(parser.parse_large_csv_chunked('data/customers-100000.csv'), 1):
