...
from utils.error_handling import (
    ErrorHandler, ApplicationError, ValidationError, NetworkError,
    FileSystemError, OCRError, AIServiceError, ConfigurationError,
    ErrorCategory, ErrorSeverity, RetryMechanism
)
from utils.validation import (
    FileValidator, TextValidator, DataValidator, ReceiptValidator
)
from services.computer_vision import ComputerVisionService
from services.ai_query import OpenRouterClient, AIQueryService
...
class TestReceiptValidator:
    ...
    def test_total_mismatch_warning(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            ReceiptValidator.validate_total_consistency(50.00, items)  # Items sum to 25.00
