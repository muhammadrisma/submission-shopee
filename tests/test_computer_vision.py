...
class TestImagePreprocessor:
    ...
    def test_preprocess_image_success(self, mock_cleanup, mock_enhance, 
                                    mock_reduce, mock_cvt, mock_imread):
...
class TestComputerVisionService:
    ...
    def test_process_receipt_success(self, mock_parse, mock_ocr, mock_preprocess):
        ...
        mock_parse.return_value = {
            ...
            'items': [{'item_name': 'Item 1', 'quantity': 1, 'unit_price': 5.99, 'total_price': 5.99}],
            'total_amount': 5.99,
            'raw_text': 'WALMART\nItem 1 $5.99\nTotal: $5.99'
        }
