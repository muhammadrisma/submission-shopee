...
class ReceiptUploadInterface:
    ...
    def render_upload_section(self) -> Optional[Dict[str, Any]]:
        ...
        st.write("Upload a food receipt image to extract and analyze your purchase data.")
    ...
    def _create_receipt_from_data(self, processed_data: Dict[str, Any], image_path: str) -> Receipt:
    ...
    def render_extracted_data_display(self, result_data: Dict[str, Any]):
        ...
        if receipt.items:
            ...
            st.info(f"📦 Total items: {total_items} | 🏷️ Unique products: {len(receipt.items)}")
        else:
